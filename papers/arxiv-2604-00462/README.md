...
- 分类：[PIC、动理学与数值模拟](../../categories/pic-and-plasma-simulation.md), [机器学习与等离子体物理](../../categories/ai-ml-plasma-physics.md), [磁约束聚变与 alpha 粒子](../../categories/magnetic-fusion-and-alpha-particles.md)
