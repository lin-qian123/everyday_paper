# Enhanced p11B fusion and alpha particle production from laser-irradiated nanowire arrays

## 基本信息

- 分类：[高能量密度物理、ICF 与实验室天体](../../categories/hedp-icf-laboratory-astrophysics.md), [PIC、动理学与数值模拟](../../categories/pic-and-plasma-simulation.md), [磁约束聚变与 alpha 粒子](../../categories/magnetic-fusion-and-alpha-particles.md)
