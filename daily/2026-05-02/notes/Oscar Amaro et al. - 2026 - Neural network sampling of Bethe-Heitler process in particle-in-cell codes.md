...
- 在OSIRIS中的典型相对论激光-等离子体问题验证显示，ML采样与传统方法在结果上可比，但更利于扩展到更复杂QED过程。

## 2. 方法与技术路线
- 训练网络预测原子序数 Z=1–50、光子能量 1 MeV–10 GeV 区间内的Bethe-Heitler截面。
- 先在简化理论问题中对齐解析/理论估计，再在PIC真实工作负载中比较传统查表方案与神经网络方案。
...
- 对当前工作可迁移的关键是“QED模块替换接口”，尤其是与现有PIC流程的耦合方式与误差控制策略。
