...
- 检索主题：激光等离子体、强场 QED、高能量密度物理、PIC、AI for plasma
...
- 推荐理由：直接展示 AI 优化在激光等离子体加速与辐射源调参中的实用价值，方法可迁移到 PIC 参数扫描和实验自动调参。
...
- 对我当前研究最值得优先阅读的 1-3 篇论文及原因：
  - 1) `10.1038/s42005-026-02542-6`：AI 优化与 LWFA 直接耦合，方法迁移价值最高。
