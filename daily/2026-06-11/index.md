...
- 与方向关系：用神经网络从线性 gyrokinetic 数据回归非线性饱和输运规则，属于 AI/ML 加速等离子体湍流建模的高相关补充。
...
- 今天补入了 3 条新的高相关 2026 预印本，分别覆盖激光尾场加速实验与 PIC 动力学、相对论守恒 PIC 数值格式，以及 AI/ML 驱动的 gyrokinetic 湍流输运建模。
