...
- 与方向关系：把 PDE foundation model 用于 ICF 多模态诊断反演与参数估计，属于 机器学习 与 HEDP 结合的高相关方法学补充。
...
- 今天补入了 3 条新的高相关 2026 预印本，分别覆盖激光等离子体辐射流体代码、真空双折射强场 QED 探测方案，以及 机器学习 驱动的 ICF 反演。
