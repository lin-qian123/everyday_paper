...
- 它不属于激光等离子体或 HEDP 主线，但很符合“机器学习在等离子体物理中的方法学进展”这个次主题。尤其如果后续后面要关注可迁移 surrogate、跨装置泛化或实时控制，这篇有明确参考价值。
...
## 5. 后续行动项
- 如果后面继续收集“机器学习用于 plasma/fusion”的代表工作，这篇适合归到 neural operator / transfer learning / real-time control 这一支。
