...
- 这篇和激光等离子体、PIC、以及 AI/ML 用于高代价仿真优化三条线都直接重合。它特别适合作为“机器学习不替代物理模拟，而是替代昂贵参数扫描”的代表案例。
...
## 5. 后续行动项
- 如果后面要整理“AI for laser-plasma / HEDP”的方法论文，这篇可以和前几天那篇质子谱 surrogate model 放在一起，对比“代理模型预测”与“贝叶斯优化找最优控制”的两类工作。
