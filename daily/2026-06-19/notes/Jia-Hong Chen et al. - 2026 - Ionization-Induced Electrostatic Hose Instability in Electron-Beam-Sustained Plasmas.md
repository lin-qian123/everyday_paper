...
- 重要点在于：它不要求特别高能的相对论电子束，只要是能够触发电离的电子束就可能出现，因此适用面比传统 hose instability 更宽，涉及放电器件、beam-generated plasma，乃至部分加速器相关场景。
...
- 虽然论文不是典型激光尾场加速场景，但它和束流等离子体耦合、横向不稳定性、PIC 验证方法是同一类技术问题。对理解尾场加速里 hose 类不稳定性的“变体”和“更一般机制”有参考价值。
