...
- 已连续维护到 `daily/2026-07-26/`。本轮按台账、重试队列和历史 daily 硬去重后，新增 2 条完成官方 PDF 校验的 arXiv 预印本 `10.48550/arXiv.2607.21362`、`10.48550/arXiv.2607.21238`，分别覆盖 ST40 偏滤器 Langmuir 探针/红外热像热流诊断，以及 HEDP 等离子体屏蔽与组态相互作用驱动的 L 壳层不透明度增强。
