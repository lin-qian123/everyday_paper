...
- 已连续维护到 `daily/2026-08-23/`。本轮新增 3 条完成官方 PDF 校验的 arXiv 预印本：`10.48550/arXiv.2608.20142` 以飞行焦点电离前沿控制双颜色等离子体 THz 波前，`10.48550/arXiv.2608.19702` 给出 SGCT-/HSG-PIC 的精确层级粒子—网格耦合加速，`10.48550/arXiv.2608.19645` 用 extrapolated-A 改进相对论撕裂模理论与二维 PIC 的波数一致性。三者分别是解析/UPPE 设计、二维数值方法基准和理想化电流片理论—PIC 比较；不能写成已验证的 THz 收集性能、生产 PIC 代码端到端加速，或激光/强场/束流/核应用实验结果。
